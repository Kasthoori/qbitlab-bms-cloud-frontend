...
const ConfirmDeleteTenantModal: FC<ConfirmDeleteTenantModalProps> = ({
  open,
  tenantId,
  tenantName,
  deleting = false,
  ...
  // allow local success animation even if parent re-renders
  useEffect(() => {
              ...
              >
                <div className="flex items-start justify-between gap-4">
                  <div>
                    ...
                    <p className="text-xs text-slate-400 break-all">ID: {tenantId}</p>
                  </div>
                ...
                {!localSuccess && (
                  <div className="text-slate-700">
                    ...
                    <div className="mt-1 text-sm text-slate-600">
                      This will permanently delete this tenant and may affect sites/HVAC under it.
                    </div>
                  </div>
                )}
