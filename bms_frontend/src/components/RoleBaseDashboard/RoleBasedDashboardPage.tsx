...
function defaultLayoutForRole(role: DashboardRole | string): WidgetLayoutItem[] {
  if (role === "SITE_MANAGER") {
    return [
      ...
      { id: "recentActivity", enabled: true, size: "medium", order: 6 },
      { id: "criticalSites", enabled: false, size: "small", order: 7 },
      { id: "energyWaste", enabled: false, size: "medium", order: 8 },
      { id: "complianceStatus", enabled: false, size: "medium", order: 9 },
    ];
  }
  ...
  if (role === "TECHNICIAN") {
    return [
      ...
      { id: "activeAlarms", enabled: true, size: "small", order: 4 },
      { id: "recentActivity", enabled: true, size: "medium", order: 5 },
  ...
  return [
    ...
    { id: "energyWaste", enabled: true, size: "medium", order: 7 },
    { id: "complianceStatus", enabled: true, size: "medium", order: 8 },
    { id: "recentActivity", enabled: false, size: "medium", order: 9 },
  ];
}
...
export default function RoleBasedDashboardPage() {
  ...
  function handleDashboardDragMove(event: DragMoveEvent) {
    ...
    if (nearRightEdge && !customizeOpen) {
