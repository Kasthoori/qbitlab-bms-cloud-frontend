...
export default function Login(props: Props) {
  ...
  const showRegistration = realm?.registrationAllowed === true && !registrationDisabled;
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-6 text-center">
            ...
            <p className="mt-1 text-sm text-slate-400">
              {realm?.displayName ? `Continue to ${realm.displayName}` : "Use your account to continue."}
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-slate-800 bg-slate-900/40 shadow-xl">
                  ...
                  <div>
                    ...
                    <input
                      className={clsx(
                        ...
                        hasError ? "border-red-900/60 focus:border-red-700" : "border-slate-800 focus:border-slate-600"
                      )}
                      id="username"
                      name="username"
            ...
            <div className="border-t border-slate-800 px-6 py-4 text-xs text-slate-500">
              <div className="flex items-center justify-between">
                <span>{realm?.displayNameHtml ? realm.displayNameHtml : "Keycloak"}</span>
                {auth?.showUsername && (
